$(document).ready(function(){
	...
	$('.include-header').html('<header id="top"><div class="nav-container"> <a href="#" class="hamburger-icon"><img src=""></a> <div class="logo"></div><ul class="menu-list"><li><a href="index.html?name=fe&email=asd%40a&message=asd#top">Inicio</a></li><li><a href="#">Nuestros socios</a></li><li><a href="index.html?name=fe&email=asd%40a&message=asd#nuestros-servicios">Nuestros servicios</a></li><li><a href="index.html?name=fe&email=asd%40a&message=asd#contact">Contacto</a></li></ul>		<div class="nav-contact"><a href="https://api.whatsapp.com/send?phone=5215519060237"><div id="wa-icon"></div></a><h4>55 20 67 37 69</h4></div></div></header>');
